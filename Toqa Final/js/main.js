    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        function filterGallery() {
            ...
            filterItems.forEach(item => {
                ...
                const roomMatch = selectedRoom === "all" || selectedRoom === itemRoom;
                const colorMatch = selectedColor === "all" || selectedColor === itemColor;

                if (styleMatch && roomMatch && colorMatch) {
        ...
        roomFilter.addEventListener("change", filterGallery);
